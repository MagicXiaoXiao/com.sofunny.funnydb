...
public static class MiniJsonExtensions
{
    ...
    public static string ToJson<T, V>(this Dictionary<T, V> obj)
    {
        return MiniJSON.jsonEncode(obj);
    }

    public static T InstanceFromJson<T>(this string json)
    {
        return (T)MiniJSON.jsonDecode(json);
    }
    public static Dictionary<T, V> InstanceFromJson<T, V>(this string json)
    {
        Hashtable hashTable = json.InstanceFromJson<Hashtable>();
        return ConvertHashTableToDictionary<T, V>(hashTable);
    }

    public static Dictionary<TKey, TValue> ConvertHashTableToDictionary<TKey, TValue>(Hashtable hashTable)
    {
